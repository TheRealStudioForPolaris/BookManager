...
class UserActives(object):
    def __init__(self,todo:str,active_id:int):
        self.todo=todo
        self.active_id=active_id

    def __user_register(self,username:str,password:str)->str:
        if self.todo!='r':
        ...
        user_creator=Core.FileIO.Write.write_user_info.WriteUserInfo('c',self.active_id)
        return user_creator.usrc(self.register_username,self.register_password)

    def usrr(self, username: str, password: str) -> str:
        return self.__user_register(username,password)
